...
import telaAdm.DeputadoEstadual;
import telaAdm.DeputadoFederal;
import telaAdm.TelaPrincipal;

public class TelaCadastrarDepFederal extends JFrame{
	JButton cadastrar;
	...
	DeputadoFederal candidato = new DeputadoFederal();
	List<Candidato> listaCandidato = new ArrayList<Candidato>();
	
	public TelaCadastrarDepFederal() {
	...
	public static void main(String[] args) {
		TelaCadastrarDepFederal janela = new TelaCadastrarDepFederal();
	}
