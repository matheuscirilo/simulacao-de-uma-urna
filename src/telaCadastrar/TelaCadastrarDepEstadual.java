...
public class TelaCadastrarDepEstadual extends JFrame {
	JButton cadastrar;
	...
	DeputadoEstadual candidato = new DeputadoEstadual();
	List<Candidato> listaCandidato = new ArrayList<Candidato>();
	
	public TelaCadastrarDepEstadual() {
	...
	public static void main(String[] args) {
		TelaCadastrarDepEstadual janela = new TelaCadastrarDepEstadual();
	}
