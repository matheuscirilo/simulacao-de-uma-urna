...
public class TelaVotaçaoGov extends JFrame {
	JButton zero;
	JButton um;
	JButton dois;
	JButton tres;
	...
	public static void main(String[] args) {
		TelaVotaçaoGov janela = new TelaVotaçaoGov();
	}
	...
	public class Manipulador implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			if (event.getSource() == confirmar) 
			{
				...
				TelaVotaçaoSen frame = new TelaVotaçaoSen();
