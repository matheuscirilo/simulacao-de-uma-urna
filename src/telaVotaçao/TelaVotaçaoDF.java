...
public class TelaVotaçaoDF extends JFrame {
	JButton zero;
	JButton um;
	JButton dois;
	JButton tres;
	...
	public TelaVotaçaoDF() {
		...
		dE = new JLabel();
		dE.setText("DEPUTADO FEDERAL");
		dE.setBounds(120, 50, 150, 50);
		tela.add(dE);
	...
	public static void main(String[] args) {
		TelaVotaçaoDF janela = new TelaVotaçaoDF();
	}
	...
	public class Manipulador implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			if (event.getSource() == confirmar) 
			{
				...
				TelaVotaçaoDE frame = new TelaVotaçaoDE();
